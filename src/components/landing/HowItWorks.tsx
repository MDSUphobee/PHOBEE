        ...
        <section className="py-24 bg-slate-50 overflow-hidden">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 border-t-2 border-dashed border-slate-300 -z-0" />
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {steps.map((step, idx) => (
                            ...
                            >
                                <div className="w-24 h-24 rounded-full bg-white border-4 border-slate-100 flex items-center justify-center text-3xl font-extrabold text-primary shadow-sm mb-6 group hover:border-primary transition-colors duration-300">
                                    {step.number}
                                </div>

...
const features = [
    {
        ...
        visual: (
            <div className="mt-4 flex flex-col gap-2 opacity-80">
                <div className="flex items-center gap-2 p-2 bg-white rounded-lg shadow-sm border border-slate-100">
                    <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center text-red-600 font-bold text-xs">15</div>
                    <div className="flex-1 h-2 bg-slate-100 rounded-full w-24" />
                </div>
                <div className="flex items-center gap-2 p-2 bg-white rounded-lg shadow-sm border border-slate-100">
                    <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs">22</div>
    ...
    },
    {
        ...
        visual: (
            <div className="mt-4 flex items-center gap-2 text-slate-400 text-xs">
                <span className="flex items-center gap-1"><div className="w-2 h-2 bg-green-400 rounded-full" /> AES-256</span>
                <span className="flex items-center gap-1"><div className="w-2 h-2 bg-green-400 rounded-full" /> GDPR Compliant</span>
            </div>
        )
    },
];

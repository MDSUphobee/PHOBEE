            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid lg:grid-cols-[55%_45%] gap-16 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        <p className="mt-8 text-[18px] text-slate-600 dark:text-white font-normal max-w-[560px] leading-relaxed">
                        ...
                        <div className="flex flex-wrap items-center justify-start mt-10 gap-4 w-full">
                            ...
                            <Link
                                href="#how-it-works"
                                className="inline-flex items-center justify-center px-8 py-4 text-[16px] font-medium text-slate-600 dark:text-white bg-transparent border border-[#D1D5DB] rounded-full hover:bg-slate-50 transition-colors"
                            >
                                Comment ça marche
                            </Link>
                        </div>
                    ...
                    <div className="relative mx-auto w-full max-w-[500px] mt-32 lg:mt-0 mb-16 lg:mb-0">
                        ...
                        >
                            <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md text-[#111827] dark:text-white px-6 py-4 rounded-[1.25rem] shadow-[0_12px_40px_rgba(0,0,0,0.1)] flex items-center gap-4 border border-white/40 dark:border-white/10 whitespace-nowrap">
                                ...
                                <div className="flex flex-col">
                                    <span className="font-bold text-[15px] md:text-[16px] text-[#2ecc71] dark:text-[#2ecc71] tracking-wide">ACRE validée</span>
                                    <span className="text-[#2ecc71]/80 dark:text-[#2ecc71]/90 text-[13px] md:text-[14px] font-medium">+3000€ économisés</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-md border border-white/60 dark:border-white/10 shadow-xl px-5 py-2 md:px-6 md:py-2.5 rounded-full flex items-center gap-3">
                        ...
                        >
                            <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-md p-4 md:p-5 rounded-[1.25rem] shadow-xl border border-white/60 dark:border-white/10">
                                <div className="flex items-start gap-4">
                                    <div className="bg-[#fef3c7] dark:bg-amber-900/30 p-2.5 rounded-full shrink-0 flex items-center justify-center">
                                        <Bell className="w-5 h-5 md:w-6 md:h-6 text-[#d97706] dark:text-amber-400 stroke-[2]" />
                                    </div>
                                    <div className="space-y-1 mt-0.5">
                                        <p className="font-bold text-[#111827] dark:text-white text-[15px] md:text-[16px]">Rappel URSSAF</p>
                                        <p className="text-[13px] md:text-[14px] text-slate-600 dark:text-white leading-snug inline-flex items-center flex-wrap">
